      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-2xl font-bold text-neutral-dark mb-2">Monthly Subscription</h1>
              <p className="text-neutral-medium">Comprehensive legal support for Australian tradies</p>
            </div>
