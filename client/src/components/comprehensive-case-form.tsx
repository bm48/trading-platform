...
export default function ComprehensiveCaseForm({ onClose, onSuccess }: ComprehensiveCaseFormProps) {
  ...
  const createCaseMutation = useMutation({
    mutationFn: async (data: ComprehensiveCaseData) => {
      // Transform comprehensive data to match case schema
      const caseData = {
        title: data.title,
        ...
        caseNumber: "", // Generated by backend
        status: "active",
        progress: 0,
  ...
  const sections = [
    { id: 1, title: 'Case Info', icon: Scale },
    { id: 2, title: 'Project', icon: Building },
    { id: 3, title: 'Contract', icon: FileText },
    { id: 4, title: 'Payment', icon: DollarSign },
    { id: 5, title: 'Legal', icon: Scale },
    { id: 6, title: 'Outcome', icon: Target },
    { id: 7, title: 'Risks', icon: AlertTriangle },
  ];
